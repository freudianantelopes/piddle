...
/**
 * @api {get} /auth/loggedin Test if there is a logged in user
 * @apiVersion 0.0.0
 * @apiName LoggedIn
 * @apiGroup Authentication
 *
 ...
 * }
 *
 * A status code response of 200 means there's a logged in user.
 * A status code response of 401 means there's not a logged in user.
 */
